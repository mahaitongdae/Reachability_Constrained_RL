...
class TD3Learner(object):
    ...
    def compute_clipped_double_q_target(self):
        ...
        target_act_tp1 += self.tf.clip_by_value(self.tf.random.normal(self.tf.shape(target_act_tp1), 0, self.args.policy_smoothing_sigma),
    ...
    def compute_gradient(self, batch_data, rb, indexes, iteration):  # compute gradient
        ...
        gradient_tensor = q_gradient1 + q_gradient2 + final_policy_gradient  # q_gradient + final_policy_gradient
