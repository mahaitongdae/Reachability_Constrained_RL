...
# @FileName: train_script4rew_shaping.py
...
def built_SAC_RewShaping_parser():
    ...
    parser.add_argument('--motivation', type=str, default='SAC-rew shaping test')  # training testing
    ...
    parser.add_argument('--optimizer_type', type=str, default='OffPolicyAsyncWithRewardShaping')
    ...
    # learner
    parser.add_argument('--alg_name', default='SAC-RewardShaping')
    ...
    parser.add_argument('--alpha_lr_schedule', type=list, default=[8e-5, int(MAX_ITER / delay_update), 8e-6])
...
def built_parser(alg_name):
    if alg_name == 'SAC-RewardShaping':
        args = built_SAC_RewShaping_parser()
