...
def built_FSAC_parser():
    ...
    parser.add_argument('--motivation', type=str, default='test optimizer')  # training testing
    ...
    parser.add_argument('--optimizer_type', type=str, default='AllReduce') # SingleProcessOffPolicy OffPolicyAsyncWithCost
    ...
    results_dir = '../results/model-free-newopt/{experiment}-{time}'.format(experiment=env_id.split('-')[1], time=time_now)
